require(["webui-cssloader"], function (loader) {
    ...
    (function ($) {
        ...
        QUnit.test('loader test', function(assert) {
            ...
            for (i = 0; i < repeat; ++i) {
                ++styleLoads[4];
                loader.inject('@style5', function () {
                    ++loads;
                    assert.ok(styleExists('files/style5.css'), 'ok style5.css');
                });
            }

            loader.inject('@style6', function () {
                ++loads;
